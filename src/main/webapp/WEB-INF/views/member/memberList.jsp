        ...
        <div class="container pt-4 px-4">
            ...
            <div class="col p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            <div class="d-flex justify-content-start w-75">
                                ...
                                <select class="form-select w-100" name="searchOption"
                                    ...
                                    ${"phone_number".equals(searchOption) ? "selected" : ""}>전화번호
                                    </option>
                                    <option value="email"
                                    ${"email".equals(searchOption) ? "selected" : ""}>이메일
                                    </option>
                                </select>
                            </div>
                    ...
                    <!-- 검색 도구 end -->
                    <button onClick="location.href='/member/new'" type="button"
                            class="btn btn-primary text-nowrap">사원 추가
                    </button>
                </div>
                ...
                <ul class="pagination pt-3 pr-3">
                    ...
                    <c:if test="${pageNum != 1}">
                        <li class="page-item"><a class="page-link"
                                                 href="/member?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum-1}">이전</a>
                        </li>
                    </c:if>
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}" step="1">
                        <li class="page-item ${i == pageNum ? 'active' : ''}"><a
                                class="page-link"
                                href="/member?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${i}">${i}</a>
                        </li>
                    </c:forEach>
                    ...
                    <c:if test="${pageNum != totalPage}">
                        <li class="page-item"><a class="page-link"
                                                 href="/member?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum+1}">다음</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
