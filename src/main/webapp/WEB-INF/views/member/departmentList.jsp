                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            <div class="d-flex justify-content-start w-75">
                                ...
                                <select class="form-select w-100" name="searchOption"
                                    ...
                                    ${"departmentId".equals(searchOption) ? "selected" : ""}>부서 번호
                                    </option>
                                </select>
                            </div>
                            ...
                            <button type="submit" id="searchButton"
                                    class="btn btn-primary ms-2 px-4 text-nowrap">검색
                            </button>
                        </div>
                    </form>
                    <!-- 검색 도구 end -->
                    <button onClick="location.href='/department/new'" type="button"
                            class="btn btn-primary text-nowrap">부서 추가
                    </button>
                </div>
                        ...
                        <table class="table table table-hover">
                            ...
                            <c:forEach var="department" items="${departmentList}">
                                <tr>
                                    ...
                                    <td>${department.totalStaffCount}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                ...
                <ul class="pagination pt-3 pr-3">
                    ...
                    <c:if test="${pageNum != 1}">
                        <li class="page-item"><a class="page-link"
                                                 href="/department?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum-1}">이전</a>
                        </li>
                    </c:if>
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}" step="1">
                        <li class="page-item ${i == pageNum ? 'active' : ''}"><a
                                class="page-link"
                                href="/department?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${i}">${i}</a>
                        </li>
                    </c:forEach>
                    ...
                    <c:if test="${pageNum != totalPage}">
                        <li class="page-item"><a class="page-link"
                                                 href="/department?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum+1}">다음</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
