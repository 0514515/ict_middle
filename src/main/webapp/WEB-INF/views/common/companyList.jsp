            ...
            <div class="col pt-4 px-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            <div class="d-flex justify-content-start w-75">
                                ...
                                <select class="form-select w-100" name="searchOption"
                                        id="searchOption">
                                    <option value="id"
                                    ${"id".equals(searchOption) ? "selected" : ""}>회사 번호
                                    </option>
                                    <option value="name"
                    ...
                    <button onClick="location.href='/super/company/new'" type="button"
                            class="btn btn-primary text-nowrap">회사 추가
                    </button>
                </div>
            </div>
                ...
                <ul class="pagination pt-3 pr-3">
                    ...
                    <c:if test="${pageNum != 1}">
                        <li class="page-item"><a class="page-link"
                                                 href="/super/company?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum-1}">이전</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageNum != totalPage}">
                        <li class="page-item"><a class="page-link"
                                                 href="/super/company?searchOption=${searchOption}&searchKeyword=${searchKeyword}&pageNum=${pageNum+1}">다음</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
